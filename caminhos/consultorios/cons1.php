...
$_SESSION['con'] = 'Consultório Número 01';
...
<body> 
  ...
  <div class="cabecao mx-auto text-center">
    <h1 class="mb-4">Bem Vindo, você está no
  Consultório 01</h1>
  </div>
            ...
            <input type="text" class="form-control" id="texto" name="texto">
              ...
              <div class="form-group" style="display: none;">
                ...
                <select class="form-control" id="local" name="local">
                  <option value="Consultório Número 01">Consultório 1</option>
                </select>
              </div>
          
              <button class="btn btn-primary" onclick="verificarLocal()" type="submit">Chamar Paciente</button>
</form>
