          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="texto" name="texto">
              ...
              <div class="form-group" style="display: none;">
                ...
                <option value="Sala de Ecografia Número 03">Ecografia 3</option>
                </select>
              </div>
...
try {
    $stmt = $db->prepare("SELECT * FROM chamar WHERE local = 'Sala de Ecografia Número 03' AND fila = 'Esperando'");
    $stmt->execute();
...
<script>
    async function chamarNovamente(id) {
        try {
            const response = await fetch('eco3.php', {
                method: 'POST',
                headers: {
