...
<head>
  ...
  <!-- Adicione o link para o Bootstrap CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="css/ecografias.css">

</head>
<body> 
<div class="container mt-5">
  <div class="cabecao mx-auto text-center">
  <h1 class="mb-4">Bem Vindo, você está na<br>
  Ecografia 1</h1>
  </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="texto" name="texto">
              ...
              <div class="form-group" style="display: none;">
                ...
                <option value="Sala de Ecografia Número 01">Ecografia 1</option>
                </select>
              </div>
...
try {
    $stmt = $db->prepare("SELECT * FROM chamar WHERE local = 'Sala de Ecografia Número 01' AND fila = 'Esperando'");
    $stmt->execute();
...
<script>
    async function chamarNovamente(id) {
        try {
            const response = await fetch('eco1.php', {
                method: 'POST',
                headers: {
