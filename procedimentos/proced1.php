          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="texto" name="texto">
              ...
              <div class="form-group" style="display: none;">
                ...
                <option value="Sala de Procedimentos Número 01">Procedimentos 1</option>
                </select>
              </div>
...
try {
    $stmt = $db->prepare("SELECT * FROM chamar WHERE local = 'Sala de Procedimentos Número 01' AND fila = 'Esperando'");
    $stmt->execute();
...
<script>
    async function chamarNovamente(id) {
        try {
            const response = await fetch('proced1.php', {
                method: 'POST',
                headers: {
